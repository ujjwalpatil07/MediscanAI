...
export default function DoctorSidebar({ isOpen, onClose, collapsed, onToggleCollapse }) {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-neutral-700 h-16">
          {!collapsed && (
          ...
          {collapsed && (
            <div className="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mx-auto">
              <Stethoscope className="w-6 h-6 text-green-600 dark:text-green-400" />
            </div>
          )}
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 transition hidden lg:flex items-center justify-center"
        ...
        <div className="p-3 border-t border-gray-200 dark:border-neutral-700">
          <Link
            to="/d/profile"
            className={`flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-700 transition ${collapsed ? "justify-center" : ""
              }`}
            title={collapsed ? "Profile" : ""}
          >
            <div className="w-9 h-9 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
              {loginUser?.profilePhoto ? (
                <img src={loginUser.profilePhoto} alt="" className="w-9 h-9 rounded-full object-cover" />
              ) : (
